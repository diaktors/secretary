 ...
 */
class User extends \Secretery\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function addRole(\Secretery\Entity\Role $role)
    {
        $this->__load();
    ...
    public function addGroup(\Secretery\Entity\Group $group)
    {
        $this->__load();

...
class Key extends \Secretary\Entity\Key implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'userId', 'pubKey', 'user', 'dateCreated', 'dateUpdated', 'inputFilter');
        }
    ...
    public function injectObjectManager(\Doctrine\Common\Persistence\ObjectManager $objectManager, \Doctrine\Common\Persistence\Mapping\ClassMetadata $classMetadata)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'injectObjectManager', array($objectManager, $classMetadata));

 ...
 */
class Group extends \Secretary\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'owner', 'dateCreated', 'dateUpdated', 'users', 'notes', 'inputFilter');
        }
     ...
     * {@inheritDoc}
     */
    public function addUser(\Secretary\Entity\User $user)
    {
